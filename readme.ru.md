...
### Особенности
Для корректной работы на вашем сервере должен быть установлен модуль PHP `imagick` для работы с gif-изображениями, имеющими несколько слоёв. А так же модуль PHP `gd` для работы с jpeg и png-изображениями. Если на вашем сайте имеются gif-изображения, имеющие несколько слоёв, и вы собираетесь их уменьшить, рассмотрите вариант отдельного запуска утилиты только для gif.
